...
A full-featured e-commerce web application with **React.js** frontend and **Go (Gin + GORM)** backend.  
Users can browse products, manage a wishlist and cart, checkout via payments, and track orders. Admins can manage products and stock.  
